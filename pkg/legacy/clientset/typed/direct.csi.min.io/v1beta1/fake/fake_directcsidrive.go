...
var directcsidrivesResource = schema.GroupVersionResource{Group: "direct.csi.min.io", Version: "v1beta1", Resource: "directcsidrives"}

var directcsidrivesKind = schema.GroupVersionKind{Group: "direct.csi.min.io", Version: "v1beta1", Kind: "DirectCSIDrive"}
...
func (c *FakeDirectCSIDrives) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.DirectCSIDrive, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(directcsidrivesResource, name), &v1beta1.DirectCSIDrive{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.DirectCSIDrive), err
}

// List takes label and field selectors, and returns the list of DirectCSIDrives that match those selectors.
func (c *FakeDirectCSIDrives) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.DirectCSIDriveList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(directcsidrivesResource, directcsidrivesKind, opts), &v1beta1.DirectCSIDriveList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1beta1.DirectCSIDriveList{ListMeta: obj.(*v1beta1.DirectCSIDriveList).ListMeta}
	for _, item := range obj.(*v1beta1.DirectCSIDriveList).Items {
...
func (c *FakeDirectCSIDrives) Create(ctx context.Context, directCSIDrive *v1beta1.DirectCSIDrive, opts v1.CreateOptions) (result *v1beta1.DirectCSIDrive, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(directcsidrivesResource, directCSIDrive), &v1beta1.DirectCSIDrive{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.DirectCSIDrive), err
...
func (c *FakeDirectCSIDrives) Update(ctx context.Context, directCSIDrive *v1beta1.DirectCSIDrive, opts v1.UpdateOptions) (result *v1beta1.DirectCSIDrive, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(directcsidrivesResource, directCSIDrive), &v1beta1.DirectCSIDrive{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.DirectCSIDrive), err
...
func (c *FakeDirectCSIDrives) UpdateStatus(ctx context.Context, directCSIDrive *v1beta1.DirectCSIDrive, opts v1.UpdateOptions) (*v1beta1.DirectCSIDrive, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(directcsidrivesResource, "status", directCSIDrive), &v1beta1.DirectCSIDrive{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.DirectCSIDrive), err
...
func (c *FakeDirectCSIDrives) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(directcsidrivesResource, name, opts), &v1beta1.DirectCSIDrive{})
	return err
}
...
func (c *FakeDirectCSIDrives) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta1.DirectCSIDriveList{})
	return err
}
...
func (c *FakeDirectCSIDrives) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.DirectCSIDrive, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(directcsidrivesResource, name, pt, data, subresources...), &v1beta1.DirectCSIDrive{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.DirectCSIDrive), err
