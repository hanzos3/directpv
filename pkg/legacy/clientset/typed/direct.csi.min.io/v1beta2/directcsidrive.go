...
func newDirectCSIDrives(c *DirectV1beta2Client) *directCSIDrives {
...
func (c *directCSIDrives) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta2.DirectCSIDrive, err error) {
	result = &v1beta2.DirectCSIDrive{}
	err = c.client.Get().
...
func (c *directCSIDrives) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.DirectCSIDriveList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta2.DirectCSIDriveList{}
	err = c.client.Get().
		Resource("directcsidrives").
...
func (c *directCSIDrives) Create(ctx context.Context, directCSIDrive *v1beta2.DirectCSIDrive, opts v1.CreateOptions) (result *v1beta2.DirectCSIDrive, err error) {
	result = &v1beta2.DirectCSIDrive{}
	err = c.client.Post().
		Resource("directcsidrives").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *directCSIDrives) Update(ctx context.Context, directCSIDrive *v1beta2.DirectCSIDrive, opts v1.UpdateOptions) (result *v1beta2.DirectCSIDrive, err error) {
	result = &v1beta2.DirectCSIDrive{}
	err = c.client.Put().
		Resource("directcsidrives").
...
func (c *directCSIDrives) UpdateStatus(ctx context.Context, directCSIDrive *v1beta2.DirectCSIDrive, opts v1.UpdateOptions) (result *v1beta2.DirectCSIDrive, err error) {
	result = &v1beta2.DirectCSIDrive{}
	err = c.client.Put().
		Resource("directcsidrives").
		Name(directCSIDrive.Name).
...
func (c *directCSIDrives) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.DirectCSIDrive, err error) {
	result = &v1beta2.DirectCSIDrive{}
