...
func (c *DirectV1alpha1Client) DirectCSIDrives() DirectCSIDriveInterface {
	return newDirectCSIDrives(c)
}

func (c *DirectV1alpha1Client) DirectCSIVolumes() DirectCSIVolumeInterface {
...
// NewForConfigAndClient creates a new DirectV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*DirectV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
