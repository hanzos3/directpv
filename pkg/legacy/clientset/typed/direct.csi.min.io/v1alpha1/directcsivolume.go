...
type DirectCSIVolumeInterface interface {
	...
	UpdateStatus(ctx context.Context, directCSIVolume *v1alpha1.DirectCSIVolume, opts v1.UpdateOptions) (*v1alpha1.DirectCSIVolume, error)
...
func (c *directCSIVolumes) UpdateStatus(ctx context.Context, directCSIVolume *v1alpha1.DirectCSIVolume, opts v1.UpdateOptions) (result *v1alpha1.DirectCSIVolume, err error) {
	result = &v1alpha1.DirectCSIVolume{}
	err = c.client.Put().
		Resource("directcsivolumes").
		Name(directCSIVolume.Name).
