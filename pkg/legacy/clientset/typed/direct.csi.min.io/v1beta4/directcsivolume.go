...
type DirectCSIVolumeInterface interface {
	Create(ctx context.Context, directCSIVolume *v1beta4.DirectCSIVolume, opts v1.CreateOptions) (*v1beta4.DirectCSIVolume, error)
	Update(ctx context.Context, directCSIVolume *v1beta4.DirectCSIVolume, opts v1.UpdateOptions) (*v1beta4.DirectCSIVolume, error)
	UpdateStatus(ctx context.Context, directCSIVolume *v1beta4.DirectCSIVolume, opts v1.UpdateOptions) (*v1beta4.DirectCSIVolume, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta4.DirectCSIVolume, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta4.DirectCSIVolumeList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta4.DirectCSIVolume, err error)
...
func newDirectCSIVolumes(c *DirectV1beta4Client) *directCSIVolumes {
...
func (c *directCSIVolumes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta4.DirectCSIVolume, err error) {
	result = &v1beta4.DirectCSIVolume{}
	err = c.client.Get().
...
func (c *directCSIVolumes) List(ctx context.Context, opts v1.ListOptions) (result *v1beta4.DirectCSIVolumeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta4.DirectCSIVolumeList{}
	err = c.client.Get().
		Resource("directcsivolumes").
...
func (c *directCSIVolumes) Create(ctx context.Context, directCSIVolume *v1beta4.DirectCSIVolume, opts v1.CreateOptions) (result *v1beta4.DirectCSIVolume, err error) {
	result = &v1beta4.DirectCSIVolume{}
	err = c.client.Post().
		Resource("directcsivolumes").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *directCSIVolumes) Update(ctx context.Context, directCSIVolume *v1beta4.DirectCSIVolume, opts v1.UpdateOptions) (result *v1beta4.DirectCSIVolume, err error) {
	result = &v1beta4.DirectCSIVolume{}
	err = c.client.Put().
		Resource("directcsivolumes").
...
func (c *directCSIVolumes) UpdateStatus(ctx context.Context, directCSIVolume *v1beta4.DirectCSIVolume, opts v1.UpdateOptions) (result *v1beta4.DirectCSIVolume, err error) {
	result = &v1beta4.DirectCSIVolume{}
	err = c.client.Put().
		Resource("directcsivolumes").
		Name(directCSIVolume.Name).
...
func (c *directCSIVolumes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta4.DirectCSIVolume, err error) {
	result = &v1beta4.DirectCSIVolume{}
