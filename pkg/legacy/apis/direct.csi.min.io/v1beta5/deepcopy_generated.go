...
func (in *DirectCSIDriveStatus) DeepCopyInto(out *DirectCSIDriveStatus) {
	*out = *in
	...
	if in.OtherMountsInfo != nil {
		in, out := &in.OtherMountsInfo, &out.OtherMountsInfo
		*out = make([]OtherMountsInfo, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OtherMountsInfo) DeepCopyInto(out *OtherMountsInfo) {
	*out = *in
	if in.MountOptions != nil {
		in, out := &in.MountOptions, &out.MountOptions
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OtherMountsInfo.
func (in *OtherMountsInfo) DeepCopy() *OtherMountsInfo {
	if in == nil {
		return nil
	}
	out := new(OtherMountsInfo)
	in.DeepCopyInto(out)
	return out
}
