...
func volumeUpgradeV1Beta1ToV1Beta2(unstructured *unstructured.Unstructured) error {
	...
	UpdateLabels(&v1beta2DirectCSIVolume, map[LabelKey]LabelValue{
		NodeLabelKey:      NewLabelValue(v1beta2DirectCSIVolume.Status.NodeName),
		CreatedByLabelKey: DirectCSIControllerName,
	})
...
func volumeUpgradeV1Beta2ToV1Beta3(unstructured *unstructured.Unstructured) error {
	...
	UpdateLabels(&v1beta3DirectCSIVolume, map[LabelKey]LabelValue{
		NodeLabelKey:      NewLabelValue(v1beta3DirectCSIVolume.Status.NodeName),
		CreatedByLabelKey: DirectCSIControllerName,
	})
